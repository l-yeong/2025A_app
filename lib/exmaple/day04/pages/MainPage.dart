...
import 'package:tj2025a_app/exmaple/day04/pages/InfoPage.dart';
import 'package:tj2025a_app/exmaple/day04/pages/SettingPage.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: [ // 바텀메뉴에 들어갈 버튼들
            ...
            BottomNavigationBarItem(icon: Icon(Icons.info,size:30),label:"정보"),
            BottomNavigationBarItem(icon: Icon(Icons.settings,color:Colors.red),label:"설정")
          ]
      ),
    );
  }
